...
public class ValoraDueWidgetProvider extends AppWidgetProvider {
    ...
    private static void updateWidget(Context context, AppWidgetManager manager, int id) {
        ...
        views.setTextViewText(R.id.widget_due_meta, dueSoon == 0
                ? context.getString(R.string.widget_due_meta_none, assetCount)
                : context.getString(R.string.widget_due_meta_review, dueSoon));
