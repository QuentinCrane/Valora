...
const Map<String, String> _zhHans = {
  ...
  'settings.glassSoftness': '玻璃柔化',
  'settings.glassSoftness.desc': '同时调整通透度与背景模糊，让液态玻璃更柔和清晰',
  'settings.glassSoftness.clear': '通透',
  'settings.glassSoftness.soft': '柔和',
  'settings.glassSoftness.frosted': '雾化',
...
const Map<String, String> _zhHansFull = {
  ...
  'analytics.dailyCostTrend': '日耗成本趋势',
  'analytics.dailyCostTrendDesc': '记录平均日耗随时间被摊薄的变化，点击查看每个节点',
  ...
  'analytics.dailyCostTrendDetail': '日耗成本趋势记录',
  'analytics.dailyCostTrendDetailDesc': '每个节点是当时可计算资产的平均日耗',
  ...
  'editor.dateBeforePurchase': '状态或目标日期不能早于购买/记录日期',
