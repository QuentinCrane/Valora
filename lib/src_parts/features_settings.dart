...
String _settingsTabLabel(_SettingsTab tab) {
  switch (tab) {
    case _SettingsTab.overview:
      return tr('settings.tab.overview');
    case _SettingsTab.data:
      return tr('settings.tab.data');
    case _SettingsTab.appearance:
      return tr('settings.tab.appearance');
    case _SettingsTab.system:
      return tr('settings.tab.system');
  }
}
...
String _settingsTabSubtitle(_SettingsTab tab) {
  switch (tab) {
    case _SettingsTab.overview:
      return tr('settings.tab.overview.subtitle');
    case _SettingsTab.data:
      return tr('settings.tab.data.subtitle');
    case _SettingsTab.appearance:
      return tr('settings.tab.appearance.subtitle');
    case _SettingsTab.system:
      return tr('settings.tab.system.subtitle');
  }
}
...
class _SettingsHomePageState extends State<SettingsHomePage> {
  ...
  Widget build(BuildContext context) {
        ...
        body: Stack(children: [
          PageFrame(
            ...
            children: [
              Row(children: [
                Expanded(
                    child: Text(_settingsTabLabel(tab),
                        style: Theme.of(context)
                            ...
                            ?.copyWith(
                                ...
                                height: 1.0,
                                letterSpacing: -.35))),
                ValuePill(tr('settings.pill.submenu')),
              ]),
              const SizedBox(height: 8),
              Text(_settingsTabSubtitle(tab),
    ...
    return PageFrame(children: [
        ...
        Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            const SizedBox(
                ...
                child: DecoratedBox(
                    decoration: BoxDecoration(
                        color: kBrandStrong, shape: BoxShape.circle))),
            const SizedBox(width: 6),
            Text(tr('settings.localMode'),
                style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.normal,
      ...
      TutorialTargetAnchor(
          id: 'settings.menu',
          child: SettingsSection(title: tr('settings.menu'), children: [
            SettingRow(
                icon: Icons.storage_rounded,
                iconBg: const Color(0xFFC8EBFF),
                label: tr('settings.dataBackup'),
                description: tr('settings.dataBackup.desc'),
                trailing: const Icon(Icons.chevron_right_rounded),
                onTap: () => _openGroup(_SettingsTab.data)),
            SettingRow(
                icon: Icons.palette_rounded,
                iconBg: const Color(0xFF8998F4),
                label: tr('settings.appearanceInteraction'),
                description: tr('settings.appearanceInteraction.desc'),
                trailing: const Icon(Icons.chevron_right_rounded),
                onTap: () => _openGroup(_SettingsTab.appearance)),
            SettingRow(
                icon: Icons.settings_applications_rounded,
                iconBg: const Color(0xFFFFE2D6),
                label: tr('settings.systemPermissions'),
                description: tr('settings.systemPermissions.desc'),
                trailing: const Icon(Icons.chevron_right_rounded),
                onTap: () => _openGroup(_SettingsTab.system)),
            SettingRow(
                icon: Icons.school_rounded,
                iconBg: const Color(0xFFBDEB7E),
                label: tr('settings.onboarding'),
                description: tr('settings.onboarding.desc'),
                trailing: ValuePill(tr('settings.start')),
                onTap: () => showOnboardingTutorial(context, markSeen: false)),
          ])),
      const SizedBox(height: 12),
      TutorialTargetAnchor(
          id: 'settings.quick',
          child: SettingsSection(title: tr('settings.quick'), children: [
            SettingRow(
                icon: Icons.category_rounded,
                iconBg: const Color(0xFFC8EBFF),
                label: tr('settings.categoryManage'),
                description:
                    '${store.categories.length} ${tr('analytics.countUnit')}，${tr('settings.categoryManage.desc')}',
                trailing: ValuePill(
                    tlf('{count} 类', {'count': '${store.categories.length}'})),
                onTap: () => showCategoryManager(context)),
            SettingRow(
                icon: Icons.backup_rounded,
                iconBg: const Color(0xFF8FD0F6),
                label: tr('settings.backupRestore'),
                description: tr('settings.backupRestore.desc'),
                trailing: ValuePill(
                    tlf('{count} 份', {'count': '${store.snapshots.length}'})),
    ...
    switch (tab) {
      case _SettingsTab.overview:
        return Column(children: [
          const FormatPreviewCard(),
          const SizedBox(height: 12),
          SettingsSection(title: tr('settings.commonManagement'), children: [
            SettingRow(
                icon: Icons.category_rounded,
                iconBg: const Color(0xFFC8EBFF),
                ...
                trailing: ValuePill(tr('settings.manage')),
            ...
            SettingRow(
                ...
                iconBg: const Color(0xFF8998F4),
                label: tr('settings.appearanceInteraction'),
                description: tl('主题、首页、金额格式、触感和提示条'),
                trailing: ValuePill(tr('settings.aggregate')),
                onTap: () => setState(() => tab = _SettingsTab.appearance)),
            SettingRow(
                icon: Icons.settings_applications_rounded,
                iconBg: const Color(0xFFFFE2D6),
                label: tr('settings.systemPermissions'),
                description: tl('小组件、权限、通知、原生接口和同步'),
                trailing: ValuePill(tr('settings.system')),
                onTap: () => setState(() => tab = _SettingsTab.system)),
          ]),
        ]);
      case _SettingsTab.data:
        return Column(children: [
          SettingsSection(title: tr('settings.assetOrg'), children: [
            SettingRow(
                icon: Icons.category_rounded,
                iconBg: const Color(0xFFC8EBFF),
                label: tr('settings.categoryManage'),
                description: tl('建议使用电子数码、学习办公等大类'),
                trailing: ValuePill(
                    tlf('{count} 类', {'count': '${store.categories.length}'})),
                onTap: () => showCategoryManager(context)),
            SettingRow(
                ...
                label: tr('settings.tagsManage'),
                description: tl('细分通勤、收藏、维修、吃灰等状态'),
                trailing: ValuePill(
                    tlf('{count} 个', {'count': '${store.tags.length}'})),
                onTap: () => showTagManager(context)),
          ]),
          const SizedBox(height: 12),
          SettingsSection(title: tr('settings.backupMigration'), children: [
            SettingRow(
                icon: Icons.backup_rounded,
                iconBg: const Color(0xFF8FD0F6),
                label: tr('settings.backupRestore'),
                description: tl('完整 ZIP、JSON、快照、CSV 和 Markdown'),
                trailing: ValuePill(
                    tlf('{count} 份', {'count': '${store.snapshots.length}'})),
                onTap: () => showBackupManager(context)),
            SettingRow(
                ...
                description: tl('WebDAV、坚果云、Nextcloud 与手动文件备份'),
            ...
            SettingRow(
                ...
                label: tr('settings.shareArchive'),
                description: tl('打包 SQLite、JSON、报告和封面/贴纸图片'),
                trailing: const ValuePill('ZIP'),
                onTap: () => shareCompleteDataArchive(context)),
          ]),
          const SizedBox(height: 12),
          SettingsSection(title: tr('settings.danger'), children: [
            SettingRow(
                icon: Icons.restore_rounded,
                iconBg: const Color(0xFFFF9F89),
                label: tr('settings.clearLocalData'),
                description: tl('删除资产、心愿、分类、标签和快照'),
                onTap: () => confirmReset(context)),
          ]),
        ]);
      case _SettingsTab.appearance:
        return Column(children: [
          SettingsSection(title: tr('settings.displayFormat'), children: [
            SettingRow(
                icon: Icons.palette_rounded,
                iconBg: const Color(0xFF8998F4),
                label: tr('settings.themeMode'),
                description: tr('settings.themeMode.desc'),
                trailing: MiniChoiceBar<ThemeSetting>(
                    value: store.settings.theme,
                    values: ThemeSetting.values,
                    labelOf: themeSettingLabel,
                    onChanged: (v) => store
                        .updateSettings(store.settings.copyWith(theme: v)))),
            SettingRow(
                icon: Icons.language_rounded,
                iconBg: const Color(0xFFD8E7FF),
                label: tr('settings.language'),
                description: tr('settings.language.desc'),
                trailing: MiniChoiceBar<AppLanguageSetting>(
                    value: store.settings.language,
                    values: AppLanguageSetting.values,
                    labelOf: (v) => v.label,
                    onChanged: (v) => store
                        .updateSettings(store.settings.copyWith(language: v)))),
            SettingRow(
              icon: Icons.blur_on_rounded,
              iconBg: const Color(0xFFE8F7FE),
              label: tr('settings.glassEffect'),
              description: store.settings.glassEffectMode.localizedDescription,
              trailing: MiniChoiceBar<GlassEffectMode>(
                value: store.settings.glassEffectMode,
                values: GlassEffectMode.values,
                labelOf: (v) => v.localizedLabel,
            ...
            SettingRow(
                ...
                iconBg: const Color(0xFFC8EBFF),
                label: tr('settings.homeStyle'),
                description: tl('卡片、列表、便利贴'),
            ...
            SettingSwitchRow(
                ...
                label: tr('settings.includeRetired'),
                description: tr('settings.includeRetired.desc'),
            ...
            SettingRow(
                ...
                label: tr('settings.currencySymbol'),
                description: tr('settings.currencySymbol.desc'),
            ...
            SettingSwitchRow(
                ...
                label: tr('settings.thousands'),
                description: tr('settings.thousands.desc'),
            ...
            SettingRow(
                ...
                label: tr('settings.durationDisplay'),
                description: tr('settings.durationDisplay.desc'),
            ...
            SettingRow(
              ...
              iconBg: const Color(0xFFE8F7FE),
              label: tr('settings.homeMetaScale'),
              description: tr('settings.homeMetaScale.desc'),
          ...
          const SizedBox(height: 12),
          SettingsSection(title: tl('交互反馈'), children: [
            SettingSwitchRow(
                icon: Icons.vibration_rounded,
                iconBg: const Color(0xFFE6D7FF),
                label: tl('触感反馈'),
                description: tl('控制 App 内点击、保存、切换等轻触感反馈'),
            ...
            SettingSwitchRow(
                ...
                label: tl('Android 原生震动'),
                description: tl('关闭后不再调用原生 Vibrator'),
            ...
            SettingSwitchRow(
                ...
                label: tl('紧凑提示条'),
                description: tl('提示条会上移并带关闭按钮，避免挡住底部操作'),
      ...
      case _SettingsTab.system:
        return Column(children: [
          ...
          const SizedBox(height: 12),
          SettingsSection(title: tl('系统与返回'), children: [
            SettingRow(
                icon: Icons.arrow_back_rounded,
                iconBg: const Color(0xFFE6F5FF),
                label: tl('场景化返回动画'),
                description: tl('详情、编辑、设置、弹层、分析页采用不同入场和返回手势反馈'),
                trailing: const ValuePill('v54'),
                onTap: () => showNativeSnack(
                    context, tl('已按页面类型区分详情/编辑/设置/弹层/分析的过渡动画和边缘返回反馈'))),
            SettingRow(
                icon: Icons.security_rounded,
                iconBg: const Color(0xFFFFE2D6),
                label: tl('权限与系统设置'),
                description: tl('通知、相机、文件、分享入口'),
                trailing: ValuePill(tr('settings.system')),
            ...
            SettingRow(
                ...
                iconBg: const Color(0xFF98E0FF),
                label: tl('刷新桌面小组件'),
                description: tl('同步资产、心愿、日均和风险数据'),
          ...
          SettingsSection(title: tl('云端快速操作'), children: [
            SettingRow(
                ...
                description: store.settings.cloudSync.enabled
                    ...
                    : tl('可选择 WebDAV、坚果云、Nextcloud 或手动文件备份'),
                trailing: ValuePill(store.settings.cloudSync.providerLabel),
                onTap: () => showCloudSyncEditor(context)),
            SettingRow(
...
class _CloudSyncPanelState extends State<CloudSyncPanel> {
  ...
  Future<void> _run(
      Future<CloudSyncResult> Function(AppStore store) task) async {
    final store = context.store;
    setState(() => busy = true);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      SettingsSection(title: tl('同步方式'), children: [
        SettingRow(
          icon: Icons.cloud_sync_rounded,
          iconBg: const Color(0xFFC8EBFF),
          label: tl('云端方案'),
        ...
        SettingSwitchRow(
          ...
          iconBg: const Color(0xFFBDEB7E),
          label: tl('保存后自动上传'),
          description: tl('适合稳定 WebDAV；网络较慢时可关闭，改用手动上传'),
          value: cloud.autoUploadOnSave,
          onChanged: (v) => store
              .updateCloudSyncSettings(cloud.copyWith(autoUploadOnSave: v)),
        ),
        SettingSwitchRow(
          icon: Icons.download_done_rounded,
          iconBg: const Color(0xFFAEE6FF),
          label: tl('启动时尝试拉取'),
          description: tl('打开 App 后自动读取云端备份；建议单设备使用时关闭'),
          value: cloud.syncOnLaunch,
          onChanged: (v) =>
              store.updateCloudSyncSettings(cloud.copyWith(syncOnLaunch: v)),
        ),
      ]),
      const SizedBox(height: 12),
      SettingsSection(title: tl('云端操作'), children: [
        SettingRow(
          icon: Icons.wifi_tethering_rounded,
          iconBg: const Color(0xFF98E0FF),
          label: tl('测试连接'),
          description: busy ? tl('正在连接云端…') : tl('使用 PROPFIND 检查 WebDAV 端点和账号'),
          trailing: ValuePill(enabled ? tl('可测试') : tl('未启用')),
        ...
        SettingRow(
          ...
          description: cloud.lastUploadAt == null
              ? tl('把当前 JSON 备份写入云端路径')
              : tlf('上次上传：{date}', {'date': dateLabel(cloud.lastUploadAt!)}),
        ...
        SettingRow(
          ...
          description: cloud.lastDownloadAt == null
              ? tl('读取云端 JSON，并覆盖当前本机数据')
              : tlf('上次读取：{date}', {'date': dateLabel(cloud.lastDownloadAt!)}),
          ...
          onTap: busy
              ...
              : () async {
                  final confirm = await showConfirmDialog(context,
                      title: tl('从云端恢复？'),
                      message: tl('这会用云端备份覆盖当前本机数据。建议先导出一份本机 JSON。'));
                  if (confirm == true) _run((s) => s.downloadCloudBackup());
                },
        ),
      ]),
      const SizedBox(height: 12),
      SettingsSection(title: tl('其他云端入口'), children: [
        SettingRow(
            icon: Icons.folder_open_rounded,
            iconBg: const Color(0xFFE6F5FF),
            label: tl('系统文件备份'),
            description: tl('导出到任意网盘同步文件夹，或从系统文件恢复'),
        ...
        SettingRow(
            ...
            iconBg: const Color(0xFFD8E7FF),
            label: tr('settings.shareArchive'),
            description: tl('打包 SQLite、JSON、CSV、报告和封面/贴纸图片'),
            trailing: const ValuePill('ZIP'),
            onTap: () => shareCompleteDataArchive(context)),
      ]),
    ]);
...
void showCloudSyncEditor(BuildContext context) {
  ...
  appSheet(
    context,
    title: tr('settings.cloudSync'),
    subtitle: tl('WebDAV 已可直接上传/读取 JSON 备份；坚果云和 Nextcloud 本质也是 WebDAV 端点。'),
      ...
      return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        RoundedSelectField<CloudSyncProvider>(
          ...
          options: CloudSyncProvider.values
              .map((e) =>
                  SelectOption(value: e, label: cloudSyncProviderLabel(e)))
              .toList(),
          onChanged: (v) {
            provider = v;
        ...
        TextField(
            controller: userCtl,
            decoration: InputDecoration(labelText: tl('账号 / 用户名'))),
        const SizedBox(height: 10),
        TextField(
            controller: passCtl,
            obscureText: true,
            decoration: InputDecoration(labelText: tl('密码 / 应用专用密码'))),
        const SizedBox(height: 10),
        TextField(
            controller: pathCtl,
            decoration: InputDecoration(
        ...
        FilledButton.icon(
          onPressed: () async {
            ...
            if (context.mounted) {
              ...
              showNativeSnack(context, tl('云端同步设置已保存'));
            }
          },
          icon: const Icon(Icons.check_rounded),
          label: Text(tl('保存云端设置')),
        ),
      ]);
    }),
  );
        ...
        return Padding(
          ...
          child: InkWell(
            ...
            child: AnimatedContainer(
              ...
              child: Text(_settingsTabLabel(item),
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 12.5,
                      fontWeight: FontWeight.normal,
...
class SettingsHeroCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final secondaryText =
        dark ? Colors.white.withOpacity(.62) : const Color(0x99141518);
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(tl('资产与心愿记录保存在当前设备，备份后可随时恢复。'),
            style: TextStyle(
                fontSize: 12.5,
                height: 1.38,
                color: secondaryText,
        ...
        Row(children: [
          Expanded(
              child: SettingsMetricPill(
                  value: '${store.categories.length}', label: tl('分类'))),
          const SizedBox(width: 8),
          Expanded(
              child: SettingsMetricPill(
                  value: '${store.tags.length}', label: tl('标签'))),
          const SizedBox(width: 8),
          Expanded(
              child: SettingsMetricPill(
                  value: '${store.snapshots.length}', label: tl('快照'))),
        ]),
      ]),
    );
  }
    ...
    return AppCard(
      ...
      child: Row(children: [
        Expanded(
          ...
          Text(tl('显示预览'),
              style: const TextStyle(
                  color: kMuted, fontSize: 12, fontWeight: FontWeight.normal)),
          const SizedBox(height: 6),
          Text(money(12345.67, store.settings),
              style: const TextStyle(
                  fontSize: 19,
                  fontWeight: FontWeight.normal,
                  letterSpacing: -.4)),
          const SizedBox(height: 5),
          Text(
              '${durationWithCalendarText(428, store.settings.durationMode)} · ${store.settings.useThousandsSeparator ? tl('千位分隔') : tl('无千位分隔')}',
...
class MiniChoiceBar<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color:
              dark ? Colors.white.withOpacity(.055) : const Color(0xFFF3F4F6),
          borderRadius: BorderRadius.circular(999)),
      child: Row(
...
String durationModeLabel(DurationMode value) {
  switch (value) {
    case DurationMode.days:
      return tr('duration.days');
    case DurationMode.weeks:
      return tr('duration.weeks');
    case DurationMode.months:
      return tr('duration.months');
    case DurationMode.years:
      return tr('duration.years');
  }
}
...
void showCurrencyDialog(BuildContext context) {
  ...
  showDialog(
      ...
      builder: (d) => AlertDialog(
              title: Text(tr('settings.currencySymbol')),
              content: TextField(
                  controller: ctl,
                  decoration:
                ...
                FilledButton(
                    onPressed: () {
                      context.store.updateSettings(context.store.settings
                          .copyWith(
                              currencyUnit: ctl.text.trim().isEmpty
                                  ? '¥'
                                  : ctl.text.trim()));
                      Navigator.pop(d);
                    },
...
void showDecimalDialog(BuildContext context) {
  ...
  showDialog(
      context: context,
      builder: (d) => AlertDialog(
              title: Text(tr('settings.decimalPlaces')),
              content: TextField(
                  controller: ctl,
              ...
              actions: [
                ...
                FilledButton(
                    onPressed: () {
                      context.store.updateSettings(context.store.settings
                          .copyWith(
                              decimalPlaces: asInt(ctl.text, fallback: 2)
                                  .clamp(0, 3)
                                  .toInt()));
                      Navigator.pop(d);
                    },
...
Widget _customIconInput(
  ...
  return TextField(
    controller: ctl,
    decoration: InputDecoration(
      labelText: tl('自定义图标 / Emoji'),
      hintText: tl('可以输入任意 Emoji，例如 🧪 / 🏎️ / 🪴'),
...
void showSmartCategoryCreateSheet(BuildContext context,
  ...
  appSheet(context, title: tl('新增分类'), subtitle: tl('不用手动输入颜色或图标，直接点选即可。'),
      child: StatefulBuilder(builder: (sheetContext, setLocal) {
      ...
      Row(children: [
        ...
        Expanded(
            child: TextField(
                ...
                autofocus: true,
                decoration: InputDecoration(
                    labelText: tl('分类名称，例如 电子数码 / 学习办公 / 家居生活')),
...
void showSmartTagCreateSheet(BuildContext context,
  ...
  appSheet(context, title: tl('新增标签'), subtitle: tl('不用手动输入颜色，直接从色板选择。'),
      child: StatefulBuilder(builder: (sheetContext, setLocal) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        CircleAvatar(
        ...
        Expanded(
            child: TextField(
                ...
                autofocus: true,
                decoration:
                    InputDecoration(labelText: tl('标签名称，例如 通勤 / 收藏 / 维修')),
                onChanged: (v) => setLocal(() {
...
void showCategoryManager(BuildContext context) {
  appSheet(context,
      title: tr('settings.categoryManage'),
      subtitle: tl('分类建议按大类管理，例如电子数码、影音娱乐、学习办公，而不是为每个手机/电脑单独建类。'),
...
class _CategoryManagerState extends State<CategoryManager> {
  ...
  Future<void> addCategory() async {
    final store = context.store;
    final now = DateTime.now().toIso8601String();
    final label = name.text.trim().isEmpty ? tl('新分类') : name.text.trim();
    await store.upsertCategory(Category(
      id: newId('cat'),
      name: label,
      icon: selectedIcon,
    ...
    appSheet(context,
      ...
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          CircleAvatar(
              backgroundColor: parseColor(colorValue),
              child: Text(iconValue, style: const TextStyle(fontSize: 20))),
          const SizedBox(width: 12),
          Expanded(
              child: TextField(
                  controller: ctl,
                  decoration: InputDecoration(labelText: tl('分类名称')),
                  onChanged: (v) => setLocal(() {
        ...
        SectionLabel(tl('图标')),
        _smartIconPicker(
            value: iconValue, onChanged: (v) => setLocal(() => iconValue = v)),
        const SizedBox(height: 10),
        _customIconInput(
            value: iconValue, onChanged: (v) => setLocal(() => iconValue = v)),
        const SizedBox(height: 14),
        ...
        SizedBox(
            ...
            child: FilledButton.icon(
                onPressed: () async {
                  await context.store.upsertCategory(category.copyWith(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          SizedBox(
              ...
              child: OutlinedButton.icon(
                onPressed: () async {
                  await context.store.applyRecommendedCategorySystem();
                  if (!context.mounted) return;
                  successHaptic();
                  setState(() {});
                  showNativeSnack(context, tl('已应用推荐大类，并迁移手机/电脑等旧小类'));
                },
                icon: const Icon(Icons.auto_awesome_rounded),
                label: Text(tl('应用推荐分类体系')),
              )),
          const SizedBox(height: 12),
          Row(children: [
            Container(
            ...
            const SizedBox(width: 8),
            FilledButton(onPressed: addCategory, child: Text(tr('common.add'))),
          ]),
          const SizedBox(height: 12),
          Wrap(spacing: 8, runSpacing: 8, children: [
            _presetChip(
      ...
      const SizedBox(height: 16),
      SectionLabel(tl('已有分类')),
      if (store.categories.isEmpty)
        Text(tl('还没有分类。'), style: const TextStyle(color: kMuted)),
      ...store.categories.map((c) => ListTile(
            ...
            title: Text(store.categoryName(c.id),
...
void showTagManager(BuildContext context) {
  appSheet(context,
      title: tr('settings.tagsManage'),
      subtitle: tl('标签适合描述场景，例如通勤、收藏、办公、长期持有。现在可以直接选颜色。'),
...
class _TagManagerState extends State<TagManager> {
  ...
  Future<void> addTag() async {
    final store = context.store;
    final label = name.text.trim().isEmpty ? tl('新标签') : name.text.trim();
    final now = DateTime.now().toIso8601String();
    await store.upsertTag(Tag(
        id: newId('tag'),
        name: label,
  ...
  void editTag(Tag tag) {
    ...
    appSheet(context, title: tl('编辑标签'), subtitle: tl('直接选择颜色即可。'),
        child: StatefulBuilder(builder: (context, setLocal) {
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          CircleAvatar(
          ...
          Expanded(
              child: TextField(
                  controller: ctl,
                  decoration: InputDecoration(labelText: tl('标签名称')),
                  onChanged: (v) =>
        ...
        SizedBox(
            ...
            child: FilledButton.icon(
                onPressed: () async {
                  await context.store.upsertTag(tag.copyWith(
                      name:
                          ctl.text.trim().isEmpty ? tag.name : ctl.text.trim(),
                      color: colorValue));
                  if (!context.mounted) return;
                  Navigator.pop(context);
                  setState(() {});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            const SizedBox(width: 8),
            FilledButton(onPressed: addTag, child: Text(tr('common.add'))),
          ]),
          const SizedBox(height: 12),
          Wrap(spacing: 8, runSpacing: 8, children: [
            _presetChip(
                icon: '🚇', label: tl('通勤'), onTap: () => applyPreset('通勤')),
            _presetChip(
      ...
      const SizedBox(height: 16),
      SectionLabel(tl('已有标签')),
      if (store.tags.isEmpty)
        Text(tl('还没有标签。'), style: const TextStyle(color: kMuted)),
      ...store.tags.map((t) => ListTile(
            contentPadding: EdgeInsets.zero,
            leading: CircleAvatar(
                backgroundColor: parseColor(t.color),
                child: const Icon(Icons.sell_rounded,
                    color: Colors.white, size: 18)),
            title: Text(store.tagName(t.id),
                style: const TextStyle(fontWeight: FontWeight.normal)),
...
void showBackupManager(BuildContext context) {
  appSheet(context,
      title: tr('settings.backupRestore'),
      subtitle: tl('推荐使用完整资料包 ZIP 迁移；JSON 只包含文字数据，不包含封面/贴纸图片。'),
      child: BackupManager());
}
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      SizedBox(
          ...
          child: OutlinedButton.icon(
              ...
              label: Text(tl('从系统文件选择 JSON（纯数据）')))),
      const SizedBox(height: 8),
      TextField(
          controller: importCtl,
          minLines: 3,
          maxLines: 5,
          decoration: InputDecoration(labelText: tl('粘贴 JSON 后覆盖恢复（不含图片）'))),
      const SizedBox(height: 8),
      OutlinedButton(
          onPressed: () async {
            final ok = await store.restoreFromJson(importCtl.text);
            if (!context.mounted) return;
            showNativeSnack(context, ok ? tl('恢复成功') : tl('JSON 格式不正确'));
            if (ok) Navigator.pop(context);
          },
          child: Text(tl('覆盖恢复'))),
      const SizedBox(height: 16),
      Row(children: [
        Expanded(child: SectionLabel(tl('本机快照'))),
        if (store.snapshots.isNotEmpty)
          Text(tlf('{count} 份', {'count': '${store.snapshots.length}'}),
              style: const TextStyle(color: kMuted, fontSize: 12)),
      ]),
...
void confirmReset(BuildContext context) {
  showDialog(
      context: context,
      builder: (d) => AlertDialog(
              title: Text(tr('settings.clearLocalData')),
              ...
              actions: [
                ...
                FilledButton(
                    onPressed: () async {
                      mediumHaptic();
                      await context.store.clearAllAndSeed();
...
class _TutorialTargetEntry {
  ...
  const _TutorialTargetEntry(
      {required this.token, required this.context, required this.seq});
}
...
class _TutorialTargetRegistry {
  ...
  static void register(String id, Object token, BuildContext context) {
    ...
    final entry =
        _TutorialTargetEntry(token: token, context: context, seq: ++_seq);
    if (existing >= 0) {
      list[existing] = entry;
    } else {
      list.add(entry);
  ...
  static _TutorialTargetEntry? _latestVisibleEntry(String id, Size screenSize) {
    ...
    for (final entry in sorted) {
      ...
      if (render is RenderBox &&
          render.attached &&
          render.hasSize &&
          !render.size.isEmpty) return entry;
    }
    return null;
  }
  ...
  static Rect? rectFor(String id, Size screenSize) {
    ...
    if (render is! RenderBox ||
        !render.attached ||
        !render.hasSize ||
        render.size.isEmpty) return null;
...
class _OnboardingOverlayRequest {
  final bool markSeen;
  final Completer<void> completer;
  _OnboardingOverlayRequest({required this.markSeen, required this.completer});
}

final ValueNotifier<_OnboardingOverlayRequest?> _onboardingOverlayRequest =
    ValueNotifier<_OnboardingOverlayRequest?>(null);

/// Request the real Shell-level onboarding overlay.
///
/// Older builds pushed a separate tutorial route that duplicated the app UI.
/// That route was fragile on first launch: it could be pushed before the Shell,
/// store hydration and target registration were stable, then immediately close.
/// The request is now handled by [ShellPage] itself, so the tutorial sits above
/// the real app interface and never marks itself completed unless the user taps
/// the final "完成" action.
Future<void> showOnboardingTutorial(BuildContext context,
    {bool markSeen = true}) {
  final completer = Completer<void>();
  _onboardingOverlayRequest.value =
      _OnboardingOverlayRequest(markSeen: markSeen, completer: completer);
...
class _OnboardingTutorialPageState extends State<OnboardingTutorialPage> {
  ...
  Future<void> _settleCurrentTarget() async {
    ...
    for (final delay in const [110, 260, 420]) {
      ...
      if (index >= currentSteps.length ||
          ...
          currentSteps[index].stage != step.stage) return;
  ...
  void _goToStep(int next) {
    ...
    if (nextStep.stage == _TutorialStage.shell) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        _pageController.animateToPage(activeTab,
  ...
  Widget _buildStage(_TutorialStepData step) {
    switch (step.stage) {
      ...
      case _TutorialStage.composeAsset:
        return ComposePage(
            initialTab: ComposeTab.asset, initialName: tl('示例资产'));
      case _TutorialStage.composeWish:
        return ComposePage(
            initialTab: ComposeTab.wish, initialName: tl('示例心愿'));
      case _TutorialStage.assetDetail:
        final first =
            context.store.assets.isEmpty ? null : context.store.assets.first;
        if (first == null)
          return ComposePage(
              initialTab: ComposeTab.asset, initialName: tl('先添加一个资产'));
        return AssetDetailPage(assetId: first.id);
      case _TutorialStage.settingsData:
        return const GradientScaffold(
            child: SettingsHomePage(
                initialTab: _SettingsTab.data, asSubPage: true));
      case _TutorialStage.settingsAppearance:
        return const GradientScaffold(
            child: SettingsHomePage(
                initialTab: _SettingsTab.appearance, asSubPage: true));
      case _TutorialStage.settingsSystem:
        return const GradientScaffold(
            child: SettingsHomePage(
                initialTab: _SettingsTab.system, asSubPage: true));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
        canPop: false,
        onPopInvoked: (didPop) {
          if (!didPop) _close(completed: false);
        },
        child: Scaffold(
          backgroundColor: Theme.of(context).scaffoldBackgroundColor,
          body: Stack(children: [
...
class _MeasuredTutorialOverlay extends StatelessWidget {
  ...
  Rect _fallbackRect(Size size, EdgeInsets safe) {
    ...
    return Rect.fromLTWH(
        22, top, size.width - 44, math.min(170.0, size.height * .26));
  }
                ...
                child: GestureDetector(
                  ...
                  child: CustomPaint(
                    painter: _TutorialScrimPainter(
                      ...
                      color:
                          Colors.black.withOpacity(context.isDark ? .60 : .52),
                ...
                child: IgnorePointer(
                  child: DecoratedBox(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(24),
                      border: Border.all(
                          color: step.color.withOpacity(.96), width: 2),
                      boxShadow: [
                        BoxShadow(
...
class _TutorialScrimPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
        start, 4.2, Paint()..color = borderColor.withOpacity(.95));
  }
...
class _TutorialBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxBubbleHeight = math.min(372.0,
              ...
              child: Column(
                  ...
                  children: [
                    Row(children: [
                      ...
                      TextButton(onPressed: onSkip, child: Text(tl('跳过'))),
                    ]),
                    const SizedBox(height: 12),
                    Text(tl(step.subtitle),
                        style: TextStyle(
                            color: dark
                    ...
                    Row(children: [
                      ...
                      Expanded(
                          child: FilledButton.icon(
                              ...
                              label: Text(isLast ? tl('完成教程') : tl('下一步')))),
                    ]),
                  ]),
            ),
          ),
